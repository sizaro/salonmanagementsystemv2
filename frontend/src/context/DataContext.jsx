...
// import { laravelApi } from "../api/laravelApi.js";
...
// // Inside your DataProvider, before the return:

// // ---------- Setup Flow State ----------
// const [setupStep, setSetupStep] = useState(1); // Step 1, 2, 3
// const [setupEmail, setSetupEmail] = useState(""); // owner email
// const [setupPhone, setSetupPhone] = useState(""); // owner phone
// const [setupSalonId, setSetupSalonId] = useState(null); // salon id
// const [setupOwnerPassword, setSetupOwnerPassword] = useState(""); // owner password
// const [setupSalonProfile, setSetupSalonProfile] = useState({
//   name: "",
//   tagline: "",
//   logo: null,
//   slug: "",
...
//   try {
//     // salonData = { name, tagline, logo }
//     const res = await nodeApi.post(`${API_URL}/setup/create-salon`, salonData, {
//       withCredentials: true,
//     });
//     return res.data; // should return { salon_id, slug, name, ... }
//   } catch (err) {
...
//   try {
//     const res = await axios.post(`${API_URL}/setup/check-user`, { email, phone });
//     return res.data; // returns { isNew, user, salon_id }
//   } catch (err) {
//     console.error("Error checking owner user:", err);
//     throw err;
//   }
// };

// // ---------- Setup Step 2: Create Owner ----------
// const createOwnerUser = async (email, password, salon_id) => {
//   try {
//     const res = await axios.post(`${API_URL}/setup/create-owner`, {
//       email,
//       password,
//       salon_id
//     });
//     return res.data; // returns new user
//   } catch (err) {
...
// // ---------- Setup Step 3: Create/Update Salon Profile ----------
// const createOrUpdateSalonProfile = async (profileData) => {
//   try {
//     const res = await axios.post(`${API_URL}/setup/create-salon-profile`, profileData);
//     return res.data; // returns salon profile including slug
//   } catch (err) {
//     console.error("Error creating/updating salon profile:", err);
//     throw err;
//   }
// };
...
//   const fetchSessions = async () => {
//     try {
//       const res = await nodeApi.get(`${API_URL}/sessions`, {
//   withCredentials: true,
// });
//       setSessions(res.data);
//     } catch (err) {
...
//     try {
//       const formatDate = (d) => new Date(d).toISOString().split("T")[0];
//       const res = await nodeApi.get(`${API_URL}/reports/daily`, {
//         params: { date: formatDate(date) },
//       }, {
//   withCredentials: true,
// });
...
//     const fetchServiceDefinitions = async () => {
//     try {
//       const res = await nodeApi.get(`${API_URL}/services/service_definitions`);
//       setServiceDefinitions(res.data.data);
//       console.log("service definitions in context:", res.data.data);
//       return res.data.data;
//     } catch (err) {
...
// const fetchServiceTransactions = async () => {
//   try {
//     const res = await nodeApi.get(`${API_URL}/services/service_transactions`);
//     setServices(res.data.data);
//     console.log("service transactions in the data context", res.data.data)
//     return res.data;
//   } catch (err) {
...
//   } catch (err) {
//     console.error("Error fetching service transactions appointments:", err);
//     setTransactions([]); // 👈 GUARANTEE safety
//   }
// };
