      ...
      <aside className="dashboard-sidebar hidden md:flex w-64 h-screen fixed top-0 left-0 flex-col shadow-xl pt-12">
        ...
        <div className="flex-1 overflow-y-auto px-2">
          <ul className="space-y-1 text-sm">
            ...
            <li>
              <Link
                to="/owner/income-report"
                className={linkClass("/owner/income-report")}
              >
                Income Reports
              </Link>
            </li>
            <li>
              <Link
                to="/owner/expenses-report"
                className={linkClass("/owner/expenses-report")}
              >
                Expenses Reports
              </Link>
            </li>
            <li>
              <Link
                ...
                className={linkClass("/owner/employee-management")}
              >
                Employee Management
              </Link>
            </li>
            <li>
              <Link
                to="/owner/employee-report"
                className={linkClass("/owner/employee-report")}
              >
                Employee Report
              </Link>
            </li>
            <li>
              <Link
                to="/owner/salon-report"
                className={linkClass("/owner/salon-report")}
              >
                Salon Report
              </Link>
            </li>
            <li>
              <Link
                to="/owner/advances"
                className={linkClass("/owner/advances")}
              >
                Employees Advances
              </Link>
            </li>
            <li>
              <Link
                ...
                className={linkClass("/owner/staff-performance")}
              >
                Staff Performance
              </Link>
            </li>
